        ...
        <footer className="border-t border-zinc-200 px-6 py-10 dark:border-zinc-800">
          <div className="mx-auto flex max-w-4xl flex-col items-center gap-5">
            ...
            <div className="flex items-center gap-5">
              ...
              {/* Email */}
              <a
                href="mailto:ditoey2002@gmail.com"
                aria-label="Email"
                className="flex items-center gap-2 text-sm text-zinc-500 transition hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-white"
              >
              ...
              {/* LinkedIn */}
              <a
                href="https://www.linkedin.com/in/donrit-ittichote-1b1426187/"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="LinkedIn"
                className="flex items-center gap-2 text-sm text-zinc-500 transition hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-white"
            ...
            <p className="text-xs text-zinc-400 dark:text-zinc-600">
              © {new Date().getFullYear()} DONRIT ITTICHOTE — All rights reserved.
            </p>
          </div>
        </footer>
      </main>
